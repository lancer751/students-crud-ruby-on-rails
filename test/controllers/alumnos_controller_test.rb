...
class AlumnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alumno" do
    assert_difference("Alumno.count") do
      post alumnos_url, params: { alumno: { address: @alumno.address, dni: @alumno.dni, edad: @alumno.edad, email: @alumno.email, lastname: @alumno.lastname, name: @alumno.name } }
    end
  ...
  test "should update alumno" do
    patch alumno_url(@alumno), params: { alumno: { address: @alumno.address, dni: @alumno.dni, edad: @alumno.edad, email: @alumno.email, lastname: @alumno.lastname, name: @alumno.name } }
